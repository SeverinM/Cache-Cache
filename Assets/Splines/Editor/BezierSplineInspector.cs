...
namespace Spline
{
    ...
    public class BezierSplineInspector : Editor
    {
        ...
        private void DrawSelectedPointInspector()
        {
            ...
            EditorGUI.BeginChangeCheck();
            Vector3 point = EditorGUILayout.Vector3Field("Position", spline.GetControlPointCount(selectedIndex));  //Line differs with origin
            if (EditorGUI.EndChangeCheck())
            {
        ...
        {
            Vector3 point = handleTransform.TransformPoint(spline.GetControlPointCount(index));
